declare namespace wasm_bindgen {
	...
	*/
	  render(image_width: number, samples_per_pixel: number, max_depth: number, concurrency: number, pool: WorkerPool): RenderingScene;
	}
	/**
	*/
...
declare interface InitOutput {
  ...
  readonly scene_render: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => void;
  ...
  readonly _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h42f0d4f244791fd0: (a: number, b: number, c: number) => void;
  readonly _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hab348892a403793f: (a: number, b: number, c: number) => void;
  readonly __wbindgen_add_to_stack_pointer: (a: number) => number;
  readonly __wbindgen_exn_store: (a: number) => void;
  readonly __wbindgen_free: (a: number, b: number) => void;
  readonly wasm_bindgen__convert__closures__invoke2_mut__h451acfc0e1a8d24e: (a: number, b: number, c: number, d: number) => void;
